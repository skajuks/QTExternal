...
namespace NetVars
{
        static RecvTable* GetTable(const char* name)
        {
                ClientClass cc;
        ...
        static int GetProp(RecvTable* pTable, const char* name)
        {
                RecvTable table;
        ...
        static int GetOffset(const char* tableName, const char* varName)
        {
